...
const Publishings = () => {
  ...
  const togglePanel = () => {
    ...
    // setState((prevState) => ({...prevState, selectedItemId: '123'}))
    // setState((prevState) => ({...prevState, isPanelVisible: true}))
  };
  ...
  const renderDetails = () => {
    ...
    if (!selectedItem) {
      return <section>Наведіть на товар для перегляду інформації</section>;
    }
  ...
  return (
    <div className="">
      ...
      <div className="mr-t-1p mr-b-1p flex">
        <div className="">
          <div className="litery-ye">
            <span className="mr-5px ">Є</span>
          </div>

          <span className="book-shop-styles">КНИГАРНЯ</span>
        </div>

        <div className="mr-l-15p  w-40p box-shadow-dark-grey flex border-r-5px">
          <div className="diagonal-background border-r-5px-no-r-b ">
            <div>КЕШБЕК ДО 35%</div>
            <div className="font-14px black">додатково до знижок</div>
          ...
          <div className="black cashback">
            ...
            <span className="bold white cashback-35">35</span>
          </div>
        </div>
        <div className="black mr-l-15p">
          <h3 className="weight-normal">Інтернет-магазин</h3>
          <h3 className="weight-normal">(0800) 33-05-65</h3>
          <h3 className="weight-normal">(044) 333-42-20</h3>
        </div>
      </div>
      ...
      <header className="header-background flex">
        ...
        <div className="w-55p">
          <form
            className="just-center mr-top-3-5 flex form-with-padd"
            action="/search"
          >
      ...
      >
        ...
        <div className="panel-right">{renderDetails()}</div>
      </div>
      <div className="back-white-dark black">
        <div className="pd-t-2p">
          <a href="" className="black ">
            <span>Книгарня "Є"</span>/
            <span className="bold ml-5px">Книгарні</span>
          </a>
        </div>
        <div className="pd-t-2p">
          <span className="bold">
        ...
        <div className="pd-t-2p">
          <h2 className="font-weight-400">Мережа книгарень</h2>
          <div>
            <ul className="padd-0">
          ...
          <div>
            <div className="bold">Інтернет-магазин</div>
            <div>support@book-ye.com</div>
            <div>0800 33 05 65</div>
          ...
          <div className="street flex">
            <div className="w-60p ">
              <h3 className="weight-normal">Київ, вул. Лисенка, 3</h3>
              <div className="dark-grey">
                <FontAwesomeIcon className="padd-r-10px" icon={faPhone} />
                (063)-373-94-76 (044) 235-88-50
                <FontAwesomeIcon
                  className="padd-l-10px padd-r-10px"
                  icon={faClock}
                />
            ...
            <div>
              <img
                className="padd-for-img-street"
                src="https://lh3.googleusercontent.com/p/AF1QipMsT71TSFmBo0JvZWRe5lbAVpTaT6uMlhYZI1Wh=s156-w156-h108-n-k-no"
                alt="ffdd"
              />
            </div>
          </div>
          ...
          <div className="street flex">
            <div className="w-60p ">
              <h3 className="weight-normal">Київ, вул. Спаська, 5</h3>
              <div className="dark-grey">
                <FontAwesomeIcon className="padd-r-10px" icon={faPhone} />
          ...
          <div className="street flex brd-b-1px-grey">
            <div className="w-60p ">
              <h3 className="weight-normal">Київ, вул. Освіти, 2</h3>
              <div className="dark-grey">
                <FontAwesomeIcon className="padd-r-10px" icon={faPhone} />
                (063)-373-95-31
                <FontAwesomeIcon
