...
const upload = multer({dest: 'uploads/', limits: {fieldSize: RESOLVED_IMG_SIZE}});
...
/*
	...
	Performs resizing if the appropriate flag comes in the request body.
*/
const uploadTempFile = (file) => {
	...
	findRemoveSync(BUCKET_FILES, {age: {seconds: 7200}, maxLevel: 1, files: '*.*'});
